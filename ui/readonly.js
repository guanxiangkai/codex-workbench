...
function providerStyle(id){const hues={zhipu:160,deepseek:220,minimax:335,kimi:275,doubao:28,qwen:185,gemini:245,claude:15};let hash=0;for(const c of String(id||'unknown'))hash=(hash*31+c.codePointAt(0))>>>0;const hue=hues[id]??hash%360;return `--type-color:hsl(${hue} 52% 36%);--type-tint:hsl(${hue} 65% 95%)`;}
